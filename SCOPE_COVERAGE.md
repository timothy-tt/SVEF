...
7. **Who is a "member" for the website library?** (31/08) The public library has
...
8. **Does the submission link go out from the platform or from a person?** (31/08)
...
9. **Whether the business directory joins the app.** Linh's directory
